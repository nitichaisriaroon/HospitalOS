...
sudo -u postgres sed -i "s/hot_standby = on/#hot_standby = on/g" /hospitalos/PostgreSQL/9.5/data/postgresql.conf
sudo -u postgres sed -i "s/wal_level/#wal_level/g" /hospitalos/PostgreSQL/9.5/data/postgresql.conf
